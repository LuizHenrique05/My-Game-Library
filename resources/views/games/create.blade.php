...
@section('title', 'Register new game')
    ...
    <div id="game-create-container" class="col-md-6 offset-md-3">
        ...
        <form action="/games" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" min="1" max="10000" step="any" name="price" id="price">
            </div>
            <div class="form-group">
                <label for="description">Game Description:</label>
                <textarea name="description" class="form-control" id="description" placeholder="Tell about your game"></textarea>
            </div>
